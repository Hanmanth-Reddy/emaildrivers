<?php
	/*	
		Created Date : SEPT  11, 2014.
		Created By   : Vipul
		Purpose      : To Insert values to akken_notifications database to send Email , SMS , Popup.	
	*/
				...
				{	
					...
					*/
					...
					if($date_expr != "")
					{
							...
							//Credential ID stored temporarily.
							...
							{	
								...
								}//End of loop for inserting data
							}//End of condition if main query generated or not 
						}//End of condition to check date expression
					}//End of condition if notification settings have data or not
			}//End of companies loop for email settings 
		}//End of condition to check for capp_info
