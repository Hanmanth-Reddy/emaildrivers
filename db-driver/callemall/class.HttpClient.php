...
class HttpClient 
{
	...
	function doRequest()
	{
		...
		$c_type=$this->getHeader("content-type");
		if($c_type["CONTENT-TYPE"]=="application/json")
			return true;
		else
			return false;
	}
	...
	function setOAUTHAuthorization($key) 
	{
		$this->OAUTH_String = $key;
	}
