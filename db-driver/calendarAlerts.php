<?php
	...
	if($meteor)
	{
		...
		while($drow=mysql_fetch_row($dres))
		{
			...
			$uque="select users.username, timezone.phpvar from users LEFT JOIN orgsetup ON users.username=orgsetup.userid LEFT JOIN timezone ON orgsetup.timezone=timezone.sno where users.usertype!='' AND users.status!='DA'";
