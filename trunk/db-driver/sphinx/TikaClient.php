...
class TikaClient
{
     ...
     * @return string $text Extracted text
     */
    public function extractTextFromFile($filename, $filecontent, $mimeType, $filenameForLog = NULL)
    {
		...
		{
			$file_ary = pathinfo($file);
			if($file_ary['extension']=="tmp")
			{
				$filename = $file_ary['basename'];
				$findme = 'apache-tika-';
