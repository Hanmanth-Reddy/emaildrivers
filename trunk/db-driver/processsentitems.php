<?php
	...
	function getActivitiesEmailCondition($ChkEmail,$tbl,$col1,$col2,$col3)
	{
		...
		{
			$tbl=$tbl.".";
			$CommonEmailCond = " (".$tbl.$col1." IN ($ChkEmail) OR ".$tbl.$col2." IN ($ChkEmail) OR ".$tbl.$col3." IN ($ChkEmail)) ";
